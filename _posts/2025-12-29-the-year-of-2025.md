...
但是今年，当我用claude code sonnet 4 集成bigquery mcp，几乎每次都能给出超出预期的数据。2025年，普通程序员用ai的过程中，产生的正反馈逐渐超过负反馈。
...
我就这这个问题，在notebookllm里进行deep research，拿到了三个非常有参考价值的文档：
...
2. [How to Measure AI Performance](https://neontri.com/blog/measure-ai-performance/)
  是如何跟踪ai的指标，如果企业要把ai作为业务的核心技术支撑，必须要开始从各方面评估ai的实际生产价值。
...
**OpenAI 的行业报告（November 2024 and November 2025），提出了，一些观察，比如：** 
...
**这个report总结道，AI 发展的限制因素已不再是模型性能，而是组织的准备程度，领先企业通常在以下五个方面做得更好：**
...
基于这些背景，在2025年这个节点，我想从公司的发展阶段来讨论这个问题。

### 短期：ai增强为主

#### 短期发展ai的问题
- 对ai认知程度不一，熟练程度不一
 - 使用方法不合适，导致使用ai的结果不和预期
 - 主观偏见
