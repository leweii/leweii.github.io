...
![Image]({{ site.url }}/assets/2020-03-18-coronita-extra/pic1.jpg)
...
我几乎是在惊慌中度过的这段日子, 每天做的最多的事就是算时间, 不停地计算, 今天过了就能排除十二号婚礼, 今天过了就能排除十八号. 并且在接下来的一段很长的时间里, 都不停的在记录每天接触的人, 每天去过哪, 今天又发生了什么"大事件"

![Image]({{ site.url }}/assets/2020-03-18-coronita-extra/pic2.jpg)
...
![Image]({{ site.url }}/assets/2020-03-18-coronita-extra/pic.jepg)
